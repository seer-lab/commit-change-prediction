...
The rest of the experimental performance results are found in \autoref{app_sub:experiment_1_svm}.
...
% TODO talk about tab:project_performance, also note how the best ones were calculated using a weighted sum for multi-variable optimization.
