...
Given the large number of project experimented on a categorization system was necessary to allow for grouping of projects. Four project measures were selected for 
...
\begin{center}
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        measure & project length & project size & \# devs & commit rate \\
        \hline
        short/small/low rate & $t < 12 m$ & $m < 2000$ & $d < 30$ & $r < 100$ \\
        medium/low rate & $12 m \leq t < 3 y$ & $2000 \leq m < 10000$ & $30 \leq d < 100$ & $100 \leq r < 300$ \\
        long/large/high rate & $t \geq 3 y$ & $m \geq 10000$ & $d \geq 100$ & $300 \leq r < 600$ \\
