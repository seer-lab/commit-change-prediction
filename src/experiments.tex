...
\begin{enumerate}
\item \textbf{acra}\footnote{\url{https://github.com/ACRA/acra}} is a Android bug logging tool used with Android applications to capture information related to bugs or crashes. The information is sent to the developers to help them address the issues that their clients encounter while using there application.
\item \textbf{arquillian-core}\footnote{\url{https://github.com/arquillian/arquillian-core}}
\item \textbf{blockly-android}\footnote{\url{https://github.com/google/blockly-android}}
\item \textbf{brave}\footnote{\url{https://github.com/openzipkin/brave}}
\item \textbf{cardslib}\footnote{\url{https://github.com/gabrielemariotti/cardslib}}
...
\item \textbf{deeplearning4j}\footnote{\url{https://github.com/deeplearning4j/deeplearning4j}} is a distributed neural network library that integrates Hadoop and Spark. This application is the largest of the 5 projects and provides a large wealth of data to analyze.
...
\item \textbf{governator}\footnote{\url{https://github.com/Netflix/governator}}
\item \textbf{greenDAO}\footnote{\url{https://github.com/greenrobot/greenDAO}}
\item \textbf{http-request}\footnote{\url{https://github.com/kevinsawicki/http-request}}
\item \textbf{ion}\footnote{\url{https://github.com/koush/ion}}
\item \textbf{jadx}\footnote{\url{https://github.com/skylot/jadx}}
\item \textbf{mapstruct}\footnote{\url{https://github.com/mapstruct/mapstruct}}
\item \textbf{nettosphere}\footnote{\url{https://github.com/Atmosphere/nettosphere}}
\item \textbf{parceler}\footnote{\url{https://github.com/johncarl81/parceler}}
\item \textbf{retrolambda}\footnote{\url{https://github.com/orfjackal/retrolambda}}
\item \textbf{ShowcaseView}\footnote{\url{https://github.com/amlcurran/ShowcaseView}}
\item \textbf{smile}\footnote{\url{https://github.com/haifengl/smile}}
\item \textbf{spark}\footnote{\url{https://github.com/perwendel/spark}}
...
\item \textbf{tempto}\footnote{\url{https://github.com/prestodb/tempto}}
\item \textbf{yardstick}\footnote{\url{https://github.com/gridgain/yardstick}}
\end{enumerate}
